...
// Floating stat cards shown on the left panel
const floatingStats = [
  { icon: CheckCircle2, label: "Compliant Plots", value: "3,842", color: "#34C759", delay: 0 },
  { icon: AlertTriangle, label: "Pending Review", value: "621", color: "#FF9F0A", delay: 0.15 },
  { icon: TrendingUp, label: "₹ Invested (Cr)", value: "1,204", color: "#007AFF", delay: 0.3 },
  { icon: Clock, label: "Defaulting", value: "48", color: "#FF3B30", delay: 0.45 },
];
  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[52%] flex-col relative overflow-hidden"
        style={{ background: "linear-gradient(145deg, #0E1117 0%, #111827 50%, #0a1628 100%)" }}>
        ...
        <motion.div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full pointer-events-none"
          style={{ background: "radial-gradient(circle, rgba(94,92,230,0.15) 0%, transparent 70%)" }}
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <motion.div className="flex items-center gap-3"
            ...
            <div>
              <h2 className="text-white font-bold text-lg leading-none tracking-tight">PlotGuardian</h2>
              <p className="text-[11px] font-medium tracking-widest uppercase" style={{ color: "rgba(255,255,255,0.4)" }}>Compliance Platform</p>
            </div>
          </motion.div>
          ...
          <motion.div className="mt-auto mb-12"
            ...
            <p className="text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.5)", maxWidth: 380 }}>
              Automate compliance tracking for allotted industrial plots — investment commitments, lease deed terms, caution deposits, and land cost subsidies — all in one intelligent platform.
            </p>
          </motion.div>
            ...
            {floatingStats.map((stat, i) => (
              <motion.div key={stat.label}
                ...
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ background: `${stat.color}22` }}>
                    <stat.icon className="w-3.5 h-3.5" style={{ color: stat.color }} />
                  </div>
                  <span className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.4)" }}>{stat.label}</span>
                </div>
          ...
          {/* Bottom footnote */}
          <motion.p className="mt-8 text-xs" style={{ color: "rgba(255,255,255,0.2)" }}
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative"
        ...
        <motion.div className="relative w-full max-w-sm"
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="font-bold text-lg" style={{ color: "#1D1D1F" }}>PlotGuardian AI</span>
          </div>
          ...
          <div className="rounded-3xl overflow-hidden"
            ...
            {/* Card header */}
            <div className="p-6 pb-5" style={{ borderBottom: "1px solid rgba(0,0,0,0.06)", background: "linear-gradient(to bottom, rgba(0,122,255,0.03), transparent)" }}>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-2xl gradient-primary flex items-center justify-center pulse-glow">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <div>
                  <p className="font-bold text-base" style={{ color: "#1D1D1F", letterSpacing: "-0.02em" }}>Sign in to PlotGuardian</p>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                  ...
                  onFocus={e => { e.target.style.borderColor = "rgba(0,122,255,0.55)"; e.target.style.boxShadow = "0 0 0 3.5px rgba(0,122,255,0.13)"; }}
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button type="button" className="text-[11px] font-semibold" style={{ color: "#007AFF" }}>Forgot password?</button>
                </div>
              ...
              <motion.button type="submit" disabled={loading}
                className="w-full py-3 rounded-2xl gradient-primary text-white text-sm font-bold flex items-center justify-center gap-2 disabled:opacity-50"
              ...
              <div className="text-center pt-1">
                <p className="text-[11px]" style={{ color: "#AEAEB2" }}>
                  Demo pre-filled · or{" "}
                  <Link to="/register" className="font-semibold" style={{ color: "#007AFF" }}>create account</Link>
                </p>
              </div>
            </form>
          </div>
